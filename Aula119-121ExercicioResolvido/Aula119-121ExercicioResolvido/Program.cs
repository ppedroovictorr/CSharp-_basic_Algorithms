...
using Aula119_121ExercicioResolvido.Entities;
using Aula119_121ExercicioResolvido.Entities.Enums;


namespace Aula119_121ExercicioResolvido
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Deppartment: " + worker.Department.Name);
